        ...
        <ul class='global-ul'>
            ...
            <ul>
                <li>De eerste twee dagen van de joodse maand Tisjrie, de zevende maand van de joodse kalender, is het Rosj
                    Hasjana, het Joods Nieuwjaar. Ook wel: 'Hoofd van het Jaar', Jom Teroe'a, de dag van het Bazuingeschal.</li>
            </ul>
            <br />
            ...
            <ul>
                <li>Soekot (Sukkot) of Loofhuttenfeest is een joods feest dat zeven dagen duurt, en waarbij herdacht wordt, dat
                    de joden veertig jaren lang in hutten in de woestijn omzwierven.</li>
            </ul>
            <br />
            ...
            <ul>
                <li>Sh'mini Atzeret. Dit feest sluit het Loofhuttenfeest (Soekot) af. Men bidt om regen in de hoop op een
                    ...
                    genoeg, maar het is voor God moeilijk om afscheid te nemen, daarom blijven de joden nog een dagje.</li>
            </ul>
            <br />
            ...
            <ul>
                <li>Simchat Thora is een vrolijke viering waarbij gedankt wordt voor de Thora (de Wetten), de eerste vijf boeken
                    ...
                    kinderen doen hieraan mee. De allerkleinsten worden door hun vader op de schouders gedragen.</li>
            </ul>
            <br />
            <li>Chanoeka</li>
            <ul>
                <li>Chanoeka is een joods feest, ook bekend als het lichtfeest of toewijdingsfeest. De eerste dag van dit feest,
                    erev chanoeka, begint na de zonsondergang van de 24e dag van de joodse maand Kislev.</li>
            </ul>
            <br />
            ...
            <ul>
                <li>Ta'anit Ester is een vastendag ter herinnering aan de drie dagen waarop door Esther, Mordechai en de hele
                    ...
                    voorafgaat aan Poerim, het vrolijke en uitbundige lentefeest van de Joden.</li>
            </ul>
            ...
            <ul>
                <li>van de Joodse kalender. Poerim (ook: Poeriem, Poerem of Purim) is een uitbundig en vrolijk voorjaarsfeest en
                    ...
                    voorgaande dag wordt er gevast tijdens Vasten van Esther (Ta'anit Ester).</li>
            </ul>
            <br />
            ...
            <ul>
                ...
                Israël, waarbij de uittocht van het joodse volk uit Egypte wordt herdacht</li>
                </ul>
                ...
                van de opstand van het Getto van Warschau.</li>
                </ul>
                <br />
                <li>Jom Ha'atsmaoet (Onafhankelijkheidsdag)</li>
                <ul>
                    <li>Viering van de geboorte van de staat Israël. Jom Ha'atsmaoet is de dag (5 Ijar 5708 ofwel 14/15 mei 1948) waarop
                        de onafhankelijkheidsverklaring van Israël werd afgekondigd en de staat werd gesticht.</li>
                </ul>
                <br />
                <li>Lag Ba'omer</li>
                <ul>
                    <li>Lag Ba'omer valt ieder jaar op 18 Ijar (meestal in mei), dat samenvalt met dag 33 van de omertelling. De tijd
                ...
                <ul>
                    <li>Eenwording van Jeruzalem. Meest recente Joodse feestdag. Herdenking van de inname van de oude stad Jeruzalem
                        ...
                        28-ste dag van de joodse maand Ijar gevierd.</li>
                </ul>
                <br />
                <li>Sjavoeot (Wekenfeest)</li>
                <ul>
                    <li>Het feest Sjavoeot wordt vijftig dagen (oftewel zeven weken) na Pesach gevierd. Sjavoeot is de Hebreeuwse naam
                        ...
                        <ul>
                            <li>Een Joodse vastendag op de 17de dag van de vierde maand (meestal in juli). Begin van de drie weken durende
                                ...
                                Tempel (in 587 v. Chr. door de Babyloniërs)</li>
                        </ul>
                        <br />
                        <li>Tisja Beav (Treurdag om Jeruzalem)</li>
                        <ul>
                            <li>Tisja Beav is de traditionele rouwdag van het jodendom. Een treurdag ter gelegenheid van de verwoesting van de
                                ...
                                slechts zwak verlicht. Ook: Tisha Beav, Tisja Be'av of Tisha b'Av.</li>
                        </ul>
                        <br />
                    ...
                    Tu b'Av wordt beschouwd als een goede dag om te trouwen, een aanzoek te doen of geloftes te vernieuwen.</li>
                    </ul>
                    <br />
                    </ul>
